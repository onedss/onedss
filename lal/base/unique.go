...
import "github.com/onedss/onedss/lal/unique"

const (
	UkPreRtmpServerSession        = "RTMP-PUBSUB"
	UkPreRtmpPushSession          = "RTMP-PUSH"
	UkPreRtmpPullSession          = "RTMP-PULL"
	UkPreRtspServerCommandSession = "RTSP-SRVCMD"
	UkPreRtspPubSession           = "RTSP-PUB"
	UkPreRtspSubSession           = "RTSP-SUB"
	UkPreRtspPushSession          = "RTSP-PUSH"
	UkPreRtspPullSession          = "RTSP-PULL"
	UkPreFlvSubSession            = "FLV-SUB"
	UkPreTsSubSession             = "TS-SUB"
	UkPreFlvPullSession           = "FLV-PULL"
